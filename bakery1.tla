...
remainderSection01(self) == /\ pc[self] = "remainderSection01"
                            /\ IF (count[self] < 1)
                                  THEN /\ IF temp[self] < Number[count[self]]
                                             THEN /\ temp' = [temp EXCEPT ![self] = Number[count[self]]]
...
\* Last modified Fri Apr 20 00:38:21 IST 2018 by aman
